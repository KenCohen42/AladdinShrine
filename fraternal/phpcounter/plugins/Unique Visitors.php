<?php
	...
	echo "<h2>Unique Visitors</h2>";
		...
		while (list($key, $val) = each($VisitorArray)){
			...
			echo  "<td class=\"DataTD\"><a href=\"index.php?Plugin=Search&amp;FilterSubmit=Search&amp;EpochPrefix=" . $TimePrefix . "&amp;FilterRemote=". $key ."\">Filter</a></td>";
