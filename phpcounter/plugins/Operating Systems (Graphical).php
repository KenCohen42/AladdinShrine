<?php
	...
	if(GetNumberOfHits()){
		...
		echo "<p><img src=\"goperatingsystems.png?" . time() . "\" alt=\"Graphical Operating Systems\"/></p>";
		...
		imagepng($image, $ImagePath);
		echo "<p><img src=\"goperatingsystems2.png?" . time() . "\" alt=\"Graphical Operating Systems\"/></p>";
